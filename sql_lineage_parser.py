    ...
    if alias:
        ...
        if isinstance(relation, Scope):
            ...
            if is_self_reference:
                ...
                # If no physical table found, continue with normal resolution but log warning
                logger.debug(f"Self-reference detected for alias {alias} but no physical table found in scope tree")
